    ...
    self.buildMarkers = function (array) {
        ...
        for (i = 0; i < array.length; i++) {
            ...
            if (array[i].placeType == "Favorite Place") {
                marker.icon = "{ url:'styles/assets/FavePin.png', scaledSize:[40,40], origin: [0,0], anchor: [16,40] }"
            } else {
                marker.icon = "{ url:'styles/assets/ExplorePin.png', scaledSize:[40,40], origin: [0,0], anchor: [16,40] }"
                marker.explore = true;
            }
